# Confluence Cloud API Spec

> The Confluence Cloud API schema over time.

![Atlassian Confluence](assets/confluence-logo-gradient-blue-attribution_rgb@2x.png)

The Atlassian Confluence Cloud API documentation is located [here](https://developer.atlassian.com/cloud/confluence/rest/intro/) on the Atlassian Developer website.
